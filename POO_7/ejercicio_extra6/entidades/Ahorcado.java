package POO_7.ejercicio_extra6.entidades;
...
public class Ahorcado {
    ...
    public boolean encontradas(char letra) {
        ...
        System.out.println("Letras totales encontradas: " + letras_encontradas + " Letras faltantes: " + (palabra.length - letras_encontradas));
