package POO_7.video_sueldo.entidades;
...
public class Vendedor {
    ...
    public Vendedor(String nombre, String dni, Double sueldoBasico, Double comisiones, Double sueldoMensual, Date fechaIngreso) {
        this.nombre = nombre;
        this.dni = dni;
        this.sueldoBasico = sueldoBasico;
        this.comisiones = comisiones;
