package POO_7.ejercicio5.entidades;
...
public class Cuenta {
    ...
    //toString
    @Override
    public String toString(){return "numeroCuenta: " + this.numeroCuenta + " dni: " + this.dni + " saldo: " + this.saldo;}
    ...
    public void consultarSaldo(){System.out.println("El saldo actual es "+this.saldo);}
