...
public class Cadena {
    ...
    public int mostrarVocales() {
        ...
        for (int i = 0; i < this.frase.length(); i++) {
            if (this.frase.charAt(i) == 'a' || this.frase.charAt(i) == 'e' || this.frase.charAt(i) == 'i'
                    || this.frase.charAt(i) == 'o' || this.frase.charAt(i) == 'u') {
                contador++;
            }
        }
        return contador;
    ...
    public void vecesRepetido(String letra) {
        ...
        System.out.println(
                "Frase: " + this.frase + " Salida: El caracter '" + letra + "' se repite " + contador + " veces.");
    }
