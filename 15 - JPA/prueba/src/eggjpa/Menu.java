...
public class Menu {
    ...
    public void ejecucion() {
        ...
        Persona p1 = personaServicio.crearPersona(nombrePersona1, apellidoPersona1, dniPersona1, nacimiento, rolUser,
                d1, mascotas1);
        Persona p2 = personaServicio.crearPersona(nombrePersona2, apellidoPersona2, dniPersona2, nacimiento, rolAdmin,
                d2, mascotas2);
