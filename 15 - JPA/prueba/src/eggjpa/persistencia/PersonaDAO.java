...
public class PersonaDAO extends DAO<Persona> {
    ...
    public List<Persona> buscarPorPaisYProvincia(String pais, String provincia) {
        conectar();
        // Opcion 1 sin JOIN
        // List<Persona> personas = em.createQuery("SELECT p FROM Persona p WHERE
        // p.direccion.pais LIKE :pais AND p.direccion.provincia LIKE :provincia ")
        // .setParameter("pais", pais).setParameter("provincia",
        // provincia).getResultList();
        // Opcion 2 con JOIN
