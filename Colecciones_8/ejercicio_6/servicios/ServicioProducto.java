package Colecciones_8.ejercicio_6.servicios;
...
public class ServicioProducto {
    ...
    public void menu(){
        ...
        while (true) {
            ...
            if (opcion==1) this.ingresarProducto();
            if (opcion==2) this.modificarProducto();
            if (opcion==3) this.eliminarProducto();
            if (opcion==4) this.mostrarProductos();
            if (opcion==5) break;
            if (opcion<1 || 5<opcion) System.out.println("Ingrese una opcion valida");
        }
        scanner.close();
    }
